...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L lib_cdc_v1_0_2 -L axi_uartlite_v2_0_19 -L xil_defaultlib -L secureip -L xpm --snapshot UART xil_defaultlib.UART -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim UART -key {Behavioral:sim_1:Functional:UART} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/Users/Maystern/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb UART.wdb xsim.dir)
